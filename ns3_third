...
CommandLine cmd;
cmd.AddValue("latency","P2P link Latency in milseconds",lat);
...
{
std::cout<<"Flow"<<i->first<<"("<<t.sourceAddress<<"t.destinationAddress="<<t.destinationAddress<<" Source port:"<<t.sourcePort<<" "<<"Destination port:"<<t.destinationPort<<"\n";
if ((t.sourceAddress=="10.1.1.1" && t.destinationAddress == "10.1.1.2"))
...
/*OUTPUT
t.sourceAddress=10.1.1.1t.destinationAddress=10.1.1.2Source port:49153 Destination port:8000
Flow1(10.1.1.1t.destinationAddress=10.1.1.2 Source port:49153 Destination port:8000
